...
<div class="cs" id="cs-leadflow" role="dialog" aria-modal="true" aria-labelledby="cs-leadflow-t">
  <div class="cs__panel">
    ...
    <div class="featgrid">
      ...
      <figure class="feat">
        <div class="feat__shot"><img src="/assets/img/feat-message.jpg" alt="Copy message, Copy LinkedIn and Open buttons on a prospect row" loading="lazy" width="1580" height="148"></div>
        <figcaption>
          <svg class="feat__arrow" viewBox="0 0 60 40" aria-hidden="true"><path d="M4 34 C 4 10, 30 4, 54 8" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round"/><path d="M46 3 L56 8 L46 14" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"/></svg>
      ...
      <figure class="feat">
        <div class="feat__shot"><img src="/assets/img/feat-stage.jpg" alt="Stage dropdown reading Loop Completed" loading="lazy" width="860" height="240"></div>
        <figcaption>
          <svg class="feat__arrow" viewBox="0 0 60 40" aria-hidden="true"><path d="M6 6 C 30 2, 52 14, 52 34" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round"/><path d="M45 27 L52 36 L59 27" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"/></svg>
      ...
      <figure class="feat">
        <div class="feat__shot"><img src="/assets/img/feat-clock.jpg" alt="Red warning text reading no answer in 34 days 10 hours" loading="lazy" width="680" height="76"></div>
        <figcaption>
          <svg class="feat__arrow" viewBox="0 0 60 40" aria-hidden="true"><path d="M4 30 C 18 6, 40 6, 55 22" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round"/><path d="M48 14 L57 24 L45 27" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"/></svg>
      ...
      <figure class="feat">
        <div class="feat__shot feat__shot--tall"><img src="/assets/img/feat-notes.jpg" alt="Notes cell listing hiring signals found for a prospect" loading="lazy" width="680" height="560"></div>
        <figcaption>
          <svg class="feat__arrow" viewBox="0 0 60 40" aria-hidden="true"><path d="M56 8 C 32 2, 10 14, 8 32" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round"/><path d="M15 25 L8 34 L1 25" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"/></svg>
