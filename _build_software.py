...
actually exists and works. The tool below is real and running. Do not add
...
.builtgrid{display:grid;grid-template-columns:1fr;gap:22px;margin-top:44px;max-width:760px}
  ...
  <div class="wrap">
    <div class="reveal">
      ...
      <p class="section-lead">
        One system in real use, carrying real data every working day. Not a prototype,
        and not slideware.
      </p>
    </div>
...
<section class="section section--alt">
  <div class="wrap">
    <div class="reveal about__lead">
      ...
      <p>
        <strong>Which is why this page shows you a working tool rather than a wall of
  ...
  <div class="cs__panel">
    ...
    <div class="slides" id="cs-slides">
      <div class="slide" data-slide="1">
        <figure class="shot slide__shot">
          <div class="shot__bar" aria-hidden="true"><i></i><i></i><i></i><b>LeadFlow Desktop</b></div>
          <video src="/assets/img/lf-sections.mp4" poster="/assets/img/lf-sections-poster.jpg"
                 autoplay muted loop playsinline preload="metadata"
                 aria-label="The sections menu opening, showing five pipelines each with a live count of items waiting"></video>
        </figure>
        <div class="slide__body">
          <div class="slide__head"><span class="slide__n">01</span><span class="slide__label">One window</span></div>
          <b>Five pipelines, one place to look</b>
          <span>Funding leads, outreach, funding outreach, multi channel, and the day itself. The number beside each is what is waiting in it right now, so the decision about what to open has already been made for you.</span>
        </div>
      </div>
      <div class="slide slide--flip" data-slide="2">
        <figure class="shot slide__shot">
          <div class="shot__bar" aria-hidden="true"><i></i><i></i><i></i><b>LeadFlow Desktop · Today</b></div>
          <img src="/assets/img/lf-today.jpg" alt="Daily queue showing ninety two actions due, each with the follow up already drafted and buttons to copy it, open the profile and mark it sent" loading="lazy" width="1500" height="812">
        </figure>
        <div class="slide__body">
          <div class="slide__head"><span class="slide__n">02</span><span class="slide__label">Daily queue</span></div>
          <b>The day arrives already sorted</b>
          <span>Ninety two actions due, ordered by how far past their window they are. Each one comes with the follow up already written for that person, their profile one click away, and a single button to mark it sent.</span>
          <em>Names and companies here are placeholders. Everything else is a live screen.</em>
        </div>
      </div>
      <div class="slide" data-slide="3">
        <figure class="shot slide__shot">
          <div class="shot__bar" aria-hidden="true"><i></i><i></i><i></i><b>LeadFlow Desktop · Multi-channel</b></div>
          <img src="/assets/img/lf-multichannel.jpg" alt="Multi channel view combining Apollo email sequences and Outflo LinkedIn campaigns with reply rates per campaign" loading="lazy" width="1500" height="850">
        </figure>
        <div class="slide__body">
          <div class="slide__head"><span class="slide__n">03</span><span class="slide__label">One pipeline</span></div>
          <b>Email and LinkedIn stop being two lists</b>
          <span>Sequences run in Apollo, campaigns run in Outflo, and neither can see the other. This pulls both into one view with reply rates per campaign, so nobody gets the same pitch twice from two directions.</span>
          <em>Names and companies here are placeholders. Everything else is a live screen.</em>
        </div>
      </div>
    </div>
