  ...
  <div class="wrap">
    <div class="reveal">
      ...
      <p class="section-lead">
        Two systems we built for our own operations and use every working day. Not
        prototypes, and not slideware. Real tools carrying real data.
      </p>
    </div>
    ...
    <div class="builtgrid">
      <div class="builtbox reveal">
        ...
        <p>
          Built to run marketing and sales pipeline work end to end: capturing leads,
          tracking every touch against them, and showing what is actually moving rather
          than what somebody remembered to update.
        </p>
        <p>
    ...
    <div class="human-note reveal" style="margin-top:34px">
      <div class="human-note__ico" aria-hidden="true">
        <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><path d="M12 9v4M12 17h.01M10.3 3.9L1.8 18a2 2 0 001.7 3h17a2 2 0 001.7-3L13.7 3.9a2 2 0 00-3.4 0z"/></svg>
      </div>
      <div>
        <h3>Why we only show you two</h3>
        <p>
          Because these are the two that exist. We would rather show you a short honest
          list than a long padded one, which is the same standard we hold ourselves to on
          the hiring side of the business.
        </p>
      </div>
    </div>
  </div>
...
<!-- ============ WHAT WE BUILD ============ -->
<section class="section section--alt" id="what-we-build">
  <div class="wrap">
    <div class="reveal">
      <span class="eyebrow">Services</span>
      <h2 class="section-title">What we build</h2>
      <p class="section-lead">
        Operational software for businesses where the work is physical, scheduled and
    ...
    <div class="pipeline">
      <div class="pill reveal">
        <div class="pill__n">01</div>
        <h3>Project and job tracking</h3>
        <p>
          Multi user systems where each role sees the view that matches their job. A
          supervisor tracks progress on the floor, accounts sees what is billable, and
          the plant head sees where things are stuck, all from the same data.
        </p>
        <ul class="pill__list">
          <li>Role based access and permissions</li>
          <li>Stage tracking with clear ownership</li>
          <li>Status visible without chasing people</li>
        </ul>
      </div>

      <div class="pill reveal">
        <div class="pill__n">02</div>
        <h3>Finance and invoicing</h3>
        <p>
          Invoice generation tied to the work that produced it, with the financial
          history kept against the job, the asset or the customer rather than scattered
          across spreadsheets and someone's inbox.
        </p>
        <ul class="pill__list">
          <li>Invoice raising and tracking</li>
          <li>Financial history per job or asset</li>
          <li>Reconciliation that does not eat a week</li>
        </ul>
      </div>

      <div class="pill reveal">
        <div class="pill__n">03</div>
        <h3>Internal operations tools</h3>
        <p>
          The systems that usually live in a spreadsheet until the spreadsheet breaks.
          Inventory movement, maintenance logs, quality records, dispatch tracking, or
          whatever your particular version of that problem is.
        </p>
        <ul class="pill__list">
          <li>Replaces fragile shared spreadsheets</li>
          <li>Built to your process, not a template</li>
          <li>Reporting and dashboards on top</li>
        </ul>
      </div>
    </div>
  </div>
...
<section class="section section--alt">
  <div class="wrap">
    <div class="reveal about__lead">
      ...
      <p>
        Animus Tech runs two arms: talent acquisition and software development. They sound
        unrelated until you notice they fail for the same reason. A bad hire and a bad
        system both come from committing before anyone understood the job properly.
      </p>
      <p>
        On the hiring side we publish our own search data, including the searches that went
        long and why. We hold software to the same standard, which is why this page shows
        you two working tools rather than a wall of logos.
      </p>
    </div>
  ...
  <div class="wrap">
    ...
    <div class="contact__grid" style="margin-top:52px">
      ...
      <form action="https://formsubmit.co/admin@animustech.in" method="POST" class="reveal reveal--right">
        ...
        <input type="hidden" name="_next" value="https://animustech.in/software/#software-contact">
