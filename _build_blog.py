...
<p>Run a realistic set of numbers and the recruitment fee typically lands somewhere between a
tenth and a fifth of the total cost of a hire that does not work out. The expensive lines are the
ones nobody invoices you for: salary paid to someone who was never going to succeed, the months
the seat sat empty, and the management hours spent on a problem that a better-defined role would
have prevented.</p>
...
""",
 "related": [("How we work, and the numbers behind it", "/how-we-work/"),
             ("Why choose us, with the numbers", "/blog/why-choose-animus-tech/")],
},
